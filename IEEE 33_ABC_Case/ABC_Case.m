...
%% Results
disp('                            ')
disp('%%%%%%%%%%%%%%%%%%% Artificial Bee Colony Results with capacitor sizing & placement %%%%%%%%%%%%%%%%%%%%%%%%%%')
disp('------------------------------------------------------')
...
disp('------------------------------------------------------')
disp('                            ')
disp('%%%%%%%%%%%%%%%%%%% Artificial Bee Colony System Results %%%%%%%%%%%%%%%%%%%%%%%%%%')
disp('------------------------------------------------------')
